...
myTerminal = "alacritty"                -- Terminal Alacritty
...
myNormColor = colorBack                 -- Color of Normal windows, imported from Colors.THEME
...
myKeys =
    ...
    -- KB_GROUP Layouts
        ...
        , ("M-S-<Tab>", prevWS)                         -- Switch to previous WorkStation
        , ("M-f", sendMessage (MT.Toggle NBFULL) >> sendMessage ToggleStruts) -- Toggles noborder/full
        , ("M-C-<Space>", sendMessage NextLayout)       -- Switch to next layout
