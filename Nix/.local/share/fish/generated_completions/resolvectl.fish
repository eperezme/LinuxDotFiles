# resolvectl
# Autogenerated from man page /run/current-system/sw/share/man/man1/resolvectl.1.gz
...
complete -c resolvectl -l stale-data -d 'Takes a boolean parameter; used in conjunction with query'
complete -c resolvectl -l json -d 'Shows output formatted as JSON'
complete -c resolvectl -s j -d 'Short for --json=auto'
