# aplaymidi
# Autogenerated from man page /run/current-system/sw/share/man/man1/aplaymidi.1.gz
...
complete -c aplaymidi -s u -l ump -d 'Changes the sequencer client to the given MIDI version and outputs via the UM…'
