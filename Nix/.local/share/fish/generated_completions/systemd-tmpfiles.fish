# systemd-tmpfiles
# Autogenerated from man page /run/current-system/sw/share/man/man8/systemd-tmpfiles.8.gz
...
complete -c systemd-tmpfiles -l graceful -d 'Ignore configuration lines pertaining to unknown users or groups'
...
complete -c systemd-tmpfiles -l image-policy -d 'Takes an image policy string as argument, as per systemd. image-policy(7)'
complete -c systemd-tmpfiles -l replace -d 'When this option is given, one or more positional arguments must be specified'
