# alsamixer
# Autogenerated from man page /run/current-system/sw/share/man/man1/alsamixer.1.gz
...
complete -c alsamixer -s B -l black-background -d 'Use the black background color'
