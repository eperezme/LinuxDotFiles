# findmnt
# Autogenerated from man page /run/current-system/sw/share/man/man8/findmnt.8.gz
...
complete -c findmnt -s y -l shell
complete -c findmnt -s h -l help
complete -c findmnt -s V -l version
