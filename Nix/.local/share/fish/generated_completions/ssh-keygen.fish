# ssh-keygen
# Autogenerated from man page /run/current-system/sw/share/man/man1/ssh-keygen.1.gz
...
complete -c ssh-keygen -s g -d 'Use generic DNS format when printing fingerprint resource records using the -…'
...
complete -c ssh-keygen -s m -d 'Specify a key format for key generation, the -i (import), -e (export) convers…'
...
complete -c ssh-keygen -s U -d 'When used in combination with -s or -Y sign, this option indicates that a CA …'
...
complete -c ssh-keygen -o 4w:+4w -d 'Valid from four weeks ago to four weeks from now'
complete -c ssh-keygen -o 1d:20110101 -d 'Valid from yesterday to midnight, January 1st, 2011'
complete -c ssh-keygen -o 1m:forever -d 'Valid from one minute ago and never expiring'
