# useradd
# Autogenerated from man page /run/current-system/sw/share/man/man8/useradd.8.gz
...
complete -c useradd -l selinux-rangeSERANGE -d 'defines the SELinux MLS range for the new account'
...
complete -c useradd -l selinux-range
