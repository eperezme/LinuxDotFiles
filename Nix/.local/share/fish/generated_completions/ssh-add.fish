# ssh-add
# Autogenerated from man page /run/current-system/sw/share/man/man1/ssh-add.1.gz
complete -c ssh-add -s c -d 'Indicates that added identities should be subject to confirmation before bein…'
complete -c ssh-add -s C -d 'When loading keys into or deleting keys from the agent, process certificates …'
...
complete -c ssh-add -o 'cert.pub' -d 'to the name of the private key file'
