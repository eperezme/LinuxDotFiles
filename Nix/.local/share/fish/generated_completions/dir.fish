# dir
# Autogenerated from man page /run/current-system/sw/share/man/man1/dir.1.gz
...
complete -c dir -s c -d 'with -lt: sort by, and show, ctime (time of last change of file status inform…'
...
complete -c dir -l time -d 'select which timestamp used to display or sort; access time (-u): atime, acce…'
