# chgrp
# Autogenerated from man page /run/current-system/sw/share/man/man1/chgrp.1.gz
...
complete -c chgrp -l reference -d 'use RFILE\'s group rather than specifying a GROUP'
