# pw-metadata
# Autogenerated from man page /run/current-system/sw/share/man/man1/pw-metadata.1.gz
...
complete -c pw-metadata -s l -l list -d 'List available metadata objects'
...
complete -c pw-metadata -s n -l name -d 'Metadata name (Default: \'default\')'
