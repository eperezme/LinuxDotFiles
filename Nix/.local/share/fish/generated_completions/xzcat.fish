# xzcat
# Autogenerated from man page /run/current-system/sw/share/man/man1/xzcat.1.gz
...
complete -c xzcat -s M -l memlimit -l memory -d 'This is equivalent to specifying  --memlimit-compress= limit  --memlimit-deco…'
complete -c xzcat -l no-adjust -d 'Display an error and exit if the memory usage limit cannot be met without adj…'
...
complete -c xzcat -l info-memory -d 'Display, in human-readable format, how much physical memory (RAM) and how man…'
