# groupadd
# Autogenerated from man page /run/current-system/sw/share/man/man8/groupadd.8.gz
...
complete -c groupadd -s o -l non-unique -d 'permits the creation of a group with an already used numerical ID'
complete -c groupadd -s p -l passwordPASSWORD -d 'defines an initial password for the group account'
...
complete -c groupadd -s P -l prefixPREFIX_DIR -d 'Apply changes to configuration files under the root filesystem found under th…'
complete -c groupadd -s U -l users -d 'A list of usernames to add as members of the group'
