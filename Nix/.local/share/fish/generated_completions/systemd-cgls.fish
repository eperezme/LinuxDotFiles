# systemd-cgls
# Autogenerated from man page /run/current-system/sw/share/man/man1/systemd-cgls.1.gz
...
complete -c systemd-cgls -s x -l xattr -d 'Controls whether to include information about extended attributes of the list…'
complete -c systemd-cgls -s c -l cgroup-id -d 'Controls whether to include the numeric ID of the listed control groups in th…'
