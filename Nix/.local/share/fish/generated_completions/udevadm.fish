# udevadm
# Autogenerated from man page /run/current-system/sw/share/man/man8/udevadm.8.gz
...
complete -c udevadm -l no-pager -d 'Do not pipe output into a pager'
...
complete -c udevadm -l version -d 'Print a short version string and exit'
complete -c udevadm -l no-summary -d 'Do not show summary'
complete -c udevadm -l no-style -d 'Ignore style issues'
