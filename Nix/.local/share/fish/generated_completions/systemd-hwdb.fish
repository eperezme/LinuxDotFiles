# systemd-hwdb
# Autogenerated from man page /run/current-system/sw/share/man/man8/systemd-hwdb.8.gz
complete -c systemd-hwdb -l usr -d 'Generate in /usr/lib/udev instead of /etc/udev'
