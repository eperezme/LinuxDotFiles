# vdir
# Autogenerated from man page /run/current-system/sw/share/man/man1/vdir.1.gz
...
complete -c vdir -s c -d 'with -lt: sort by, and show, ctime (time of last change of file status inform…'
...
complete -c vdir -l time -d 'select which timestamp used to display or sort; access time (-u): atime, acce…'
