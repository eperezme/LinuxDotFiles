# ssh-keyscan
# Autogenerated from man page /run/current-system/sw/share/man/man1/ssh-keyscan.1.gz
...
complete -c ssh-keyscan -s O -d 'Specify a key/value option.  At present, only a single option is supported:'
...
complete -c ssh-keyscan -o nosplit
