# ls
# Autogenerated from man page /run/current-system/sw/share/man/man1/ls.1.gz
...
complete -c ls -s c -d 'with -lt: sort by, and show, ctime (time of last change of file status inform…'
