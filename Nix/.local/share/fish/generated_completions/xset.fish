# xset
# Autogenerated from man page /run/current-system/sw/share/man/man1/xset.1.gz
complete -c xset -o display -d 'This option specifies the server to use; see X(7). PP'
complete -c xset -o dpms -d 'The -dpms option disables Display Power Management Signaling (DPMS) features'
