# systemd-nspawn
# Autogenerated from man page /run/current-system/sw/share/man/man1/systemd-nspawn.1.gz
...
complete -c systemd-nspawn -l image-policy -d 'Takes an image policy string as argument, as per systemd. image-policy(7)'
