# install
# Autogenerated from man page /run/current-system/sw/share/man/man1/install.1.gz
...
complete -c install -l debug -d 'explain how a file is copied.   Implies -v'
...
complete -c install -s v -l verbose -d 'print the name of each created file or directory'
