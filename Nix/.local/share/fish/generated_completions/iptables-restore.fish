# iptables-restore
# Autogenerated from man page /run/current-system/sw/share/man/man8/iptables-restore.8.gz
...
complete -c iptables-restore -s M -l modprobe -d 'Specify the path to the modprobe(8) program'
