# less
# Autogenerated from man page /run/current-system/sw/share/man/man1/less.1.gz
...
complete -c less -l header -d 'Sets the number of header lines and columns displayed on the screen'
