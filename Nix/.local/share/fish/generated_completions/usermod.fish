# usermod
# Autogenerated from man page /run/current-system/sw/share/man/man8/usermod.8.gz
...
complete -c usermod -l selinux-rangeSERANGE -d 'defines the SELinux MLS range for the new account'
...
complete -c usermod -l selinux-range
