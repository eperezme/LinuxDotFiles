# axfer-transfer
# Autogenerated from man page /run/current-system/sw/share/man/man1/axfer-transfer.1.gz
...
complete -c axfer-transfer -l disable-resample -d 'This option has an effect for \'plug\' plugin in alsa-lib to suppress conversio…'
complete -c axfer-transfer -l disable-channels -d 'This option has an effect for \'plug\' plugin in alsa-lib to suppress conversio…'
complete -c axfer-transfer -l disable-format -d 'This option has an effect for \'plug\' plugin in alsa-lib to suppress conversio…'
complete -c axfer-transfer -l disable-softvol -d 'This option has an effect for \'softvol\' plugin in alsa-lib to suppress conver…'
