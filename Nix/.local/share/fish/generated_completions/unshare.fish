# unshare
# Autogenerated from man page /run/current-system/sw/share/man/man1/unshare.1.gz
...
complete -c unshare -l map-users
complete -c unshare -l map-group
complete -c unshare -l map-groups
complete -c unshare -l map-auto
...
complete -c unshare -o rw-r--r-- -d '# exit $ ls -ln --time-style=+ file'
