# ping
# Autogenerated from man page /run/current-system/sw/share/man/man8/ping.8.gz
...
complete -c ping -s C -d 'Call connect() syscall on socket creation'
complete -c ping -s d -d 'Set the SO_DEBUG option on the socket being used'
complete -c ping -s e -d 'Set the identification field of ECHO_REQUEST'
complete -c ping -s D -d 'Print timestamp (unix time + microseconds as in gettimeofday) before each line'
complete -c ping -s f -d 'Flood ping.  For every ECHO_REQUEST sent a period "'
