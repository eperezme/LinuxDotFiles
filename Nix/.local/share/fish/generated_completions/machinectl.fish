# machinectl
# Autogenerated from man page /run/current-system/sw/share/man/man1/machinectl.1.gz
...
complete -c machinectl -l kill-whom -d 'When used with kill, choose which processes to kill'
...
complete -c machinectl -s E -l setenv -d 'When used with the shell command, sets an environment variable for the execut…'
...
complete -c machinectl -l now -d 'When used with enable or disable, the containers will also be started or powe…'
...
complete -c machinectl -l max-addresses -d 'When used with the list-machines command, limits the number of IP addresses s…'
...
complete -c machinectl -l pty -d 'switch to acquire an interactive shell, similarly to machinectl shell'
