# blkdeactivate
# Autogenerated from man page /run/current-system/sw/share/man/man8/blkdeactivate.8.gz
...
complete -c blkdeactivate -s v -l verbose -d 'Run in verbose mode.  Use -vv for even more verbose mode'
