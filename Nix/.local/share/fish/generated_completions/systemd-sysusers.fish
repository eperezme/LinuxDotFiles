# systemd-sysusers
# Autogenerated from man page /run/current-system/sw/share/man/man8/systemd-sysusers.8.gz
...
complete -c systemd-sysusers -l image-policy -d 'Takes an image policy string as argument, as per systemd. image-policy(7)'
complete -c systemd-sysusers -l dry-run -d 'Process the configuration and figure out what entries would be created, but d…'
