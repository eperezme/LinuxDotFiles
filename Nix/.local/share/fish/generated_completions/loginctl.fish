# loginctl
# Autogenerated from man page /run/current-system/sw/share/man/man1/loginctl.1.gz
...
complete -c loginctl -l kill-whom -d 'When used with kill-session, choose which processes to kill'
