...
class AccountSelectionTile extends Tile {
  constructor(state, onAdvance, onLicenseActivation) {
    super();
  ...
  display(state) {
    ...
    const cloudFeatures = `
      <div class="plan-feature enabled">Live sync of dynamic data between any table and Google Sheets.</div>
      <div class="plan-feature enabled">Magic Columns: AI-enhanced data parsing and extraction.</div>
    `;
    ...
    slide.innerHTML = `
      <div class="container">
        <div class="big-text">Account Selection</div>
            ...
            <div class="plan col-lg-4">
              <div class="inner">
                ...
                <div class="plan-footer">
                  ...
                  <div class="footer-footer">14-day Free Trial&nbsp;&nbsp;&middot;&nbsp;&nbsp;Billed Annually</div>
                </div>
              </div>
            </div>
            <div class="plan col-lg-4">
              <div class="inner">
                ...
                <div class="plan-footer">
                  <button class="btn btn-default btn-lg" disabled data-attr-plan="cloud">Coming Soon</button>
