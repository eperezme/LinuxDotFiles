class OnboardManager {
  ...
  getHash_() {
    ...
    const initialSlideType = SlideTypes.WELCOME;
    ...
    return { slideType: initialSlideType };
  }

  initialize() {
    const hashState = this.getHash_();
    ...
    this.path_ = [
      ...
      new ActivateLicenseTile(hashState, this.userConfig_),
    ];
